<?php echo $this->Form->create('Newslettersemail', array('class'=>'mws-form', 'id'=>'form_contentpost')) ?>
	<div class="mws-panel grid_8 pages">
		<div class="mws-panel-header">
	    	<span class="mws-i-24 i-list">Atualizar Email</span>
	    </div>
	    <div class="mws-panel-body">
			<div class="mws-form-inline">
			<?php
				echo $this->Form->hidden('id', array('value'=>$this->Form->value('Newslettersemail.id')));
    		...
    		<?php
				echo $this->Html->link(__('Ver todas os Emails', true), array('action' => 'index'),array('class'=>'mws-button gray small fl'));

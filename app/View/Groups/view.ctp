...
<div class="mws-panel grid_8 newslettersgroups">
	<div class="mws-panel-header">
    	<span class="mws-i-24 i-list">Contas de Emails do grupo <b><?php echo $group['Group']['nome']?></b></span>
    </div>
    <div class="mws-panel-body">

    	<div class="mws-panel-toolbar top clearfix">
        	<ul>
            	<li><?php echo $this->Html->link(__('Ver todos os Emails', true), array('controller'=>'emails', 'action' => 'index'),array('class'=>'mws-button gray'));?></li>
            	<li><?php echo $this->Html->link(__('Voltar para os grupos', true), array('controller'=>'groups', 'action' => 'index'),array('class'=>'mws-button gray'));?></li>
        ...
        <div class="PopUpImport formulario">
        	...
        	<?php echo $this->Form->input('categorias_grupos',array('type'=>'hidden','value'=>$group['Group']['id'] )); ?>
							...
							if(empty($email['Group'])){
								...
								foreach ($email['Group'] as $emailgroup) {
									echo  ' <span class="hg-yellow">'. 
										...
										$this->Html->link( utf8_decode($emailgroup['nome']) , array('controller'=>'groups','action' => 'view', $emailgroup['id']),array('class'=>'mws-buttons gray small'))

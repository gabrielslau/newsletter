 ...
 */
// $min_serveOptions['maxAge'] = 1800; // 30 minutos
$min_serveOptions['maxAge'] = 604800; // uma semana (em segundos)
...
$min_serveOptions['rewriteCssUris'] = false; // desativa a reescrita da url das imagens no css
